    ...
    <div className="w-80 h-screen bg-white shadow-md p-4 px-6 flex flex-col text-left">
        ...
        <nav className="text-sm">
          <div className="font-semibold flex items-center gap-2 py-3">
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M6.52734 13V8.5H9.52734V13H13.2773V7H15.5273L8.02734 0.25L0.527344 7H2.77734V13H6.52734Z" fill="#3E3F5E" />
            </svg>
            <span>HOME</span>
          </div>
          <div className="font-bold flex items-center gap-2 py-3 pt-5 cursor-pointer" onClick={() => toggleSection("censor")}>
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M0.25 15.5V5H3.25V15.5H0.25ZM5.5 15.5V0.5H8.5V15.5H5.5ZM10.75 15.5V9.5H13.75V15.5H10.75Z" fill="#3E3F5E" />
            </svg>
            <span>Censor</span>
          ...
          <div className="font-bold flex items-center gap-2 py-3 pt-5 cursor-pointer" onClick={() => toggleSection("system")}>
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M17.25 0.5H0.75V12.5H17.25V0.5ZM10.1895 8.375L12.0645 6.5L10.1895 4.625L11.25 3.5645L14.1855 6.5L11.25 9.4355L10.1895 8.375ZM6.75 9.4355L3.8145 6.5L6.75 3.5645L7.8105 4.625L5.9355 6.5L7.8105 8.375L6.75 9.4355ZM15.75 14H2.25V15.5H15.75V14Z" fill="#3E3F5E" />
            </svg>
      ...
      <div className="text-left pt-8">
        <div className="mb-2 text-md flex items-center gap-3 cursor-pointer">
          <img src={default_avatar} alt="default_avatar" className="w-12 rounded-full"></img>
