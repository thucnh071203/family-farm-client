    ...
    return(
      ...
      <div className="popup-delete-service-container w-[450px] h-[200px] bg-white px-3 py-2 rounded-md shadow-[0px_0px_17px_0px_rgba(66,68,90,1)]">
        <div className="header-popup">
          ...
          <div className="border border-solid border-gray-600 mt-3"></div>
        </div>
        <div className="body-popup mt-4">
          <div className="text-start">Are you sure you want to delete?</div>
        </div>
        <div className="footer-popup mt-16 text-end">
