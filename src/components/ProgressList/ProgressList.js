            ...
            <div class="div px-2 max-w-7xl mx-auto">
                ...
                <div class="progress-container w-full mt-6 lg:mt-14 flex flex-col lg:flex-row lg:justify-center gap-6">
                    ...
                    <div class="progress-right w-full lg:w-[66.5%] xl:w-[830px] lg:max-w-[830px]">
                        ...
                        <div class="group-5 w-full sm:w-[85%] md:w-[78%] xl:w-[644px] xl:max-w-[644px] flex flex-row justify-between items-center mt-8">
                            <div class="frame-16">
                                <img class="img" src={nameFilterIcon} />
                                <div class="text-wrapper-16">Name progress</div>
                            </div>
                            <div class="text-wrapper-17 mr-[12%] sm:mr-0 sm:ml-[8%] lg:ml-[7%] xl:ml-[34px]">Owner</div>
                            <div class="text-wrapper-18 lg:ml-0 hidden sm:block">Status</div>
                        </div>
