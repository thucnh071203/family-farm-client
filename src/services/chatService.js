...
export const handleSend = async ({
    ...
    try {
        ...
        if (selectedFile) {
            ...
            formData.append("FileType", selectedFile.type.startsWith("image/") ? "image" : "file");
        }
...
export const removeSelectedFile = ({ selectedFile, setSelectedFile, imageInputRef, fileInputRef }) => {
    if (selectedFile?.url) {
        URL.revokeObjectURL(selectedFile.url);
    }
    setSelectedFile(null);
